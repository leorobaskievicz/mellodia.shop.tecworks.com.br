...
export default function Footer({ children }) {
  ...
  return (
    <Grid container sx={styleContainer}>
      <Grid item xs={false} sm={false} md={1} lg={2} xl={2} sx={{ ...styleContainerContent, backgroundColor: "#F2F2F2", display: { xs: "none", sm: "none", md: "block" } }} />
      <Grid container xs={12} sm={12} md={9} lg={8} xl={8} sx={{ ...styleContainerContent, backgroundColor: "#F2F2F2" }}>
        <Grid item xs={6} sm={6} md={2} lg={2} xl={2} sx={styleContainerContentItem}>
          ...
          <List dense>
            <ListItem disableGutters sx={styleContainerContentItemListItem}>
              <ListItemText primary="Relacionamento com o cliente" sx={styleContainerContentItemButton} onClick={() => router.push("/central-de-relacionamento")} />
            </ListItem>
            <ListItem sx={styleContainerContentItemListItem}>
              <ListItemText primary="Política de Devolução" sx={styleContainerContentItemButton} onClick={() => router.push("/central-de-relacionamento?aba=trocas")} />
            </ListItem>
            <ListItem sx={styleContainerContentItemListItem}>
              <ListItemText primary="Política de Privacidade" sx={styleContainerContentItemButton} onClick={() => router.push("/politica-de-privacidade")} />
            </ListItem>
            <ListItem sx={styleContainerContentItemListItem}>
              <ListItemText primary="Política de Frete" sx={styleContainerContentItemButton} onClick={() => router.push("/politica-de-frete")} />
            </ListItem>
            <ListItem sx={styleContainerContentItemListItem}>
              <ListItemText primary="Consumidor.gov.br" sx={styleContainerContentItemButton} onClick={() => router.push("https://consumidor.gov.br/")} />
            </ListItem>
            <ListItem sx={styleContainerContentItemListItem}>
              <ListItemText primary="Código de defesa do consumidor" sx={styleContainerContentItemButton} onClick={() => router.push("https://consumidor.gov.br/")} />
            </ListItem>
            <ListItem sx={styleContainerContentItemListItem}>
        ...
        <Grid item xs={6} sm={6} md={2} lg={3} xl={3} sx={styleContainerContentItem}>
          ...
          <List dense>
            ...
            <ListItem sx={styleContainerContentItemListItem}>
              <ListItemText primary="Meus endereços" sx={styleContainerContentItemButton} onClick={() => router.push("/perfil/editar/endereco")} />
            </ListItem>
            <ListItem sx={styleContainerContentItemListItem}>
              <ListItemText primary="Alterar senha" sx={styleContainerContentItemButton} onClick={() => router.push("/meu-cadastro#grid-alterar-senha")} />
            </ListItem>
            <ListItem sx={styleContainerContentItemListItem}>
          ...
          <Button variant="contained" size="large" color="primary" sx={{ px: 4, mt: 1, mb: 2 }} onClick={() => router.push("/institucional/trabalhe-conosco")}>
            Envie seu currículo
          </Button>
        </Grid>
        <Grid item xs={6} sm={6} md={2} lg={2} xl={2} sx={styleContainerContentItem}>
        ...
        <Grid item xs={12} sm={12} md={2} lg={3} xl={3} sx={{ ...styleContainerContentItem, alignItems: { xs: "center", md: "flex-start" }, mt: { xs: 4, md: 0 } }}>
          <Typography sx={styleContainerContentItemTitle}>Cadastre-se para receber novidades e promoções exclusivas</Typography>
          <Box>
            <FooterNewsletter />
          </Box>
      ...
      <Grid item xs={false} sm={false} md={1} lg={2} xl={2} sx={{ ...styleContainerContent, backgroundColor: "#F2F2F2", display: { xs: "none", md: "block" } }} />
      <Grid container xs={12} sm={12} md={9} lg={8} xl={8} sx={{ ...styleContainerContent }}>
        ...
        <Grid item xs={12} sm={12} md={6} lg={5} xl={5} sx={{ ...styleContainerContentItem, alignItems: { xs: "center", md: "flex-start" }, mt: { xs: 2, md: 0 } }}>
          ...
          <Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-around" }}>
            ...
            <Image src="/clearsale-logo.png" alt="Site integrado a ClearSale" width={100} height={30} style={{ marginRight: 10 }} />
            <Image src="/rapidSSL.png" alt="Site usa certificado RapidSSL" width={100} height={30} style={{ marginRight: 10 }} />
          ...
          <Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-around" }}>
            ...
            {process.env.NEXT_PUBLIC_APP_STORE_URL && (
              <a href={process.env.NEXT_PUBLIC_APP_STORE_URL}>
                <Image alt="Disponível no App Store" src={"/appstore-download.svg"} className="app-download lazyload" width={120} height={33} />
              </a>
            )}
          </Box>
        </Grid>
