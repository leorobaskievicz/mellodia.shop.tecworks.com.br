...
export default function PoliticaDePrivacidade() {
  return (
    <>
      <section
        className="politica-de-privacidade"
        style={{ margin: "60px auto", width: 800, marginLeft: "auto", marginRight: "auto", textAlign: "left" }}
      >
        ...
        <article>
          ...
          <p>
            Em caso de imprevistos com a entrega (clima, trânsito, greves, etc.), o cliente será informado por nossos
            canais oficiais.
          </p>
