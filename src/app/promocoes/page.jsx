...
import { getProdutoByPromocao } from "@/app/lib/funcoes";
...
export default async function Promocoes(props) {
  ...
  const jsonLd = {
    ...
    "@type": "Product",
    url: `https://www.divacosmeticos.com.br/${Diversos.toSeoUrl(slug)}`,
